...
const dietSchema = zod_1.z.object({
    ...
    grams: zod_1.z.number().min(0).max(100000),
    calories: zod_1.z.number().min(0).max(50000),
    protein: zod_1.z.number().min(0).max(10000),
    carbs: zod_1.z.number().min(0).max(10000),
    fat: zod_1.z.number().min(0).max(10000),
});
const exerciseSchema = zod_1.z.object({
    ...
    duration: zod_1.z.number().min(0).max(86400),
    calories: zod_1.z.number().min(0).max(50000),
...
const shoppingSchema = zod_1.z.object({
    ...
    specGrams: zod_1.z.number().min(0).max(100000),
...
const weightSchema = zod_1.z.object({
    userId: zod_1.z.string().trim().optional(),
    date: zod_1.z.string().min(1),
    weight: zod_1.z.number().min(1).max(1000),
