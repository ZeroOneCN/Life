...
export const menuItems: MenuItemConfig[] = [
  ...
  },
  {
    ...
    label: '璐㈠姟涓績',
    children: [
      { key: '/finance/shopping', icon: 'task', label: '缃戜笂璐墿' },
...
export const routes: RouteConfig[] = [
  ...
  { path: '/finance/shopping', label: '缃戜笂璐墿', breadcrumb: ['璐㈠姟涓績', '缃戜笂璐墿'], menuKey: '/finance/shopping', component: ShoppingPage },
