...
export const menuItems: MenuItemConfig[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: '/finance/subscription', icon: 'bell', label: '服务订阅(待开发)' },
...
export const routes: RouteConfig[] = [
  ...
  { path: '/finance/subscription', label: '服务订阅(待开发)', breadcrumb: ['财务中心', '服务订阅(待开发)'], menuKey: '/finance/subscription', component: SubscriptionPage },
