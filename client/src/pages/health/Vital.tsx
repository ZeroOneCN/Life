...
export default function VitalPage() {
  ...
  useEffect(() => {
    ...
    void vitalApi
      .getTrend(selectedMetric, trendPeriod)
      .then((data) => {
      ...
      <Row gutter={[24, 20]}>
        ...
        {activeTab === 'vital' ? (
          <>
            ...
            <Col span={24}>
              <VitalOverviewSection overview={vitalOverview} loading={vitalOverviewLoading} />
            </Col>
            <Col span={24}>
              <VitalTrendSection
                trend={vitalTrend}
          ...
          <>
            <Col span={24}>
              <SleepEntrySection loading={sleepEntryLoading} onSubmit={handleSleepSubmit} />
            </Col>
            <Col span={24}>
              <SleepOverviewSection overview={sleepOverview} loading={sleepOverviewLoading} />
            </Col>
            <Col span={24}>
              <SleepTrendSection
                trend={sleepTrend}
            ...
            footer={
              <>
                <button
                  ...
                  onClick={() => setEditVitalOpen(false)}
                >
                  取消
                </button>
                <button
            ...
            {editingVitalRecord ? (
              <div className="form-stack">
                <div className="form-field">
                  ...
                  <input
                    type="text"
                    value={editingVitalRecord.metricLabel}
                    disabled
            ...
            footer={
              <>
                <button
                  type="button"
                  className="btn btn-secondary"
                  onClick={() => setEditSleepOpen(false)}
                >
                  取消
                </button>
                <button
                  ...
                  <div className="vital-entry-metric-tabs">
                    {QUALITY_OPTIONS.map((q) => (
                      <button
                        ...
                        onClick={() =>
                          setEditSleepQuality(editSleepQuality === q.value ? null : q.value)
                        }
                      >
                        {q.emoji} {q.label}
                      </button>
