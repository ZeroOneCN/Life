...
- **加密市场** (`/investment/crypto`)：交易平台管理 + 交易记录 + 统计看板 + Excel 批量导入；多平台聚合盈亏分析；绿涨红跌
- **港股市场** (`/investment/hk-stock`)：交易平台管理 + 交易记录 + 统计看板 + Excel 批量导入；多平台聚合盈亏分析；红涨绿跌
- **美股市场** (`/investment/us-stock`)：交易平台管理 + 交易记录 + 统计看板 + Excel 批量导入；多平台聚合盈亏分析；绿涨红跌
